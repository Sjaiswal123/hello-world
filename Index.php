	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
				...
				<p class="meta"><span class="date">Home Page</span></p>
				<div style="clear: both;">&nbsp;</div>
				<div class="entry">
                                    <p>
									
<img src="images/img2.jpg" style="width:500px;height:350px"/>
...
Created by KQED and NPR, MindShift explores the future of learning in all its dimensions, covering cultural and technology trends, innovations in education, groundbreaking research, education policy, and more.
	...
	<div id="footer">
		<p>Copyright (c)  All rights reserved. Design by Shivani Jaiswal</a>.</p>
	</div>
	<!-- end #footer -->
</body>
</html>
